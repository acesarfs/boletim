...
class BoletimEmailTesteForm extends ConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Você confirma o envio do (%titulo) para o email teste?',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $email = trim($config->get('emailteste'));
    if(empty($email)) {
